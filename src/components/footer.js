...
export default function Footer({ hidden }) {
    return hidden ? (
        ...
        <div className="bg-gradient-to-r from-gunmetal to-mint dark:to-gunmetal">
            <div className="container mx-auto px-8 flex flex-wrap mt-52 py-16 gap-x-24 gap-y-4 min-h-[300px] overflow-x-hidden w-full justify-between z-50">
